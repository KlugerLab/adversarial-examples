...
def fourier_blockwise(attack_dir, denoise_base_dir, lowPassRadius, highPassRadius):
    ...
    for l2_dir in l2_dir_list:
        ...
        output_dir  =  denoise_base_dir + fourier_blockwise.__name__ + '_' + str(lowPassRadius) + '/' + attack_name + '/' + l2_distance + '/'
        ...
        script_name = 'denoise_fourier_blockwise' # if args exits: 'test Arg1 Arg2'
